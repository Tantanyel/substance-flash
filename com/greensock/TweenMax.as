...
TweenMax.killAll(false, false, true, false);
		...
		public static function killAllFirst(complete: Boolean = false, tweens: Boolean = true, delayedCalls: Boolean = true, timelines: Boolean = true): void {
			var a: Array = getAllTweens(timelines),
				l: int = a.length,
				isDC: Boolean,
				allTrue: Boolean = (tweens && delayedCalls && timelines),
